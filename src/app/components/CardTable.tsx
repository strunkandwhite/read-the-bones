  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor(
        (row) => (useTopPlayerWeighting ? row.topPlayerGeomean : row.weightedGeomean),
        {
          id: "pickScore",
          header: () => (
      ...
      columnHelper.display({
        id: "history",
        header: "History",
        cell: ({ row }) => <Sparkline history={row.original.scoreHistory} />,
      }),
    ...
    [useTopPlayerWeighting, currentCubeCopies, showWinEquity, showRawWinRate]
  );
